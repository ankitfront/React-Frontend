...
const ProductSidebar = () => {
  ...
  return (
    <aside className="w-64 min-h-screen bg-white border-r flex flex-col justify-between">
      ...
      <div>
        <div className="flex items-center gap-3 px-7 py-7 border-b">
      ...
      <div className="p-4">
        <div className="rounded-2xl bg-gradient-to-br from-indigo-600 to-purple-500 p-5 text-white">
          ...
          <p className="text-sm text-indigo-100 mt-2">
            Unlock analytics & bulk order tools.
          </p>

          <button className="w-full bg-white text-indigo-600 rounded-xl py-3 mt-5 font-semibold hover:bg-gray-100 transition">
            Upgrade Plan
          </button>
        </div>
      </div>
